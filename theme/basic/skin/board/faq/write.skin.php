...
<section id="bo_w">
	...
	※ 출력순서 사용
	1. wr_7 int형으로 변경
	2. /bbs/list.php 151줄 else if($bo_table=='faq') { $sst = 'wr_7 asc, wr_num, wr_reply'; } 추가
	-->
	<!--
	<div class="write_div">
		<label for="wr_7" class="sound_only">순서</label>
		<input type="text" name="wr_7" value="<?php echo $wr_7 ?>" id="wr_7" class="frm_input" size="10" placeholder="순서" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')">
	</div>
	-->
